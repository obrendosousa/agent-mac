...
enum ChappieConfigFile {
    private static let logger = Logger(subsystem: "ai.chappie", category: "config")
    ...
    static func stateDirURL() -> URL {
        ChappiePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ChappiePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-chappie-config-file",
            "event": "config.write",
