...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.chappie", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Chappie/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__chappie__/a2ui/").absoluteString + "?platform=macos"
    }
