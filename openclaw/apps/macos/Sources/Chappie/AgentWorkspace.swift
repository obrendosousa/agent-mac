...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.chappie", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ChappieConfigFile.defaultWorkspaceURL() }
