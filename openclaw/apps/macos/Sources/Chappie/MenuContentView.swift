...
/// Menu contents for the Chappie menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Chappie") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Chappie Not Configured"
        case .remote:
            "Remote Chappie Active"
        case .local:
            "Chappie Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .chappieSelectSettingsTab, object: tab)
        }
    }
