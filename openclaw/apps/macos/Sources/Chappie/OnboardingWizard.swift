...
private let onboardingWizardLogger = Logger(subsystem: "ai.chappie", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between ChappieProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = ChappieProtocol.AnyCodable
