...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.chappie", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.chappie", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ChappieChatMessage] = messages.compactMap { item in
