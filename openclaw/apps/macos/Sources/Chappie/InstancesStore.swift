...
final class InstancesStore {
    ...
    private let logger = Logger(subsystem: "ai.chappie", category: "instances")
    ...
    func handlePresenceEventPayload(_ payload: ChappieProtocol.AnyCodable) {
        do {
...
extension InstancesStore {
    static func preview(instances: [InstanceInfo] = [
        InstanceInfo(
            ...
            mode: "local",
            reason: "preview",
            text: "Local node: chappie-team-mac (10.0.0.12) · app 1.2.3",
