...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.chappie", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Chappie windows, but below the system’s pop-up menus.
