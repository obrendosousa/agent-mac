...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/chappie/chappie") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/chappie/chappie")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://chappie.ai")
                AboutLinkRow(icon: "bird", title: "Twitter", url: "https://twitter.com/chappie-team")
                AboutLinkRow(icon: "envelope", title: "Email", url: "mailto:peter@chappie-team.me")
            }
            ...
            Text("© 2025 Chappie Team — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ChappieBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ChappieBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ChappieGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ChappieGitCommit") as? String) ??
            "unknown"
    }
