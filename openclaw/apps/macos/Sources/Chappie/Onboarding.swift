...
enum UIStrings {
    static let welcomeTitle = "Welcome to Chappie"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "chappie.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ChappieChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g chappie@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ChappieChatViewModel(
