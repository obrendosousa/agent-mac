...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.chappie", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".chappie/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.chappieCommand(
            subcommand: "gateway",
