...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .chappieSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ChappiePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ChappiePaths.stateDirURL.path
...
extension Notification.Name {
    static let chappieSelectSettingsTab = Notification.Name("chappieSelectSettingsTab")
}
