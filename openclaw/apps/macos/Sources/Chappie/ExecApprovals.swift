...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.chappie", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ChappiePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ChappiePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
