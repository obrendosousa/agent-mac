...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ChappieConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ChappieConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: ChappieConfigFile.loadDict(),
        ...
        ChappieConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/chappie"
        state.remoteCliPath = ""
        return state
    }
}
