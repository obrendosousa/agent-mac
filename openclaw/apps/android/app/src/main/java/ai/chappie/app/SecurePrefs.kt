...
class SecurePrefs(
  ...
  companion object {
    val defaultWakeWords: List<String> = listOf("chappie", "claude")
    private const val displayNameKey = "node.displayName"
    private const val locationModeKey = "location.enabledMode"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "chappie.node"
    private const val securePrefsName = "chappie.node.secure"
  }
