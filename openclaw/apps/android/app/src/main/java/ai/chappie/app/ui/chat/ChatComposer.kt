...
import ai.chappie.app.ui.mobileSurface
import ai.chappie.app.ui.mobileText
import ai.chappie.app.ui.mobileTextSecondary
import ai.chappie.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.chappie.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.chappie.app.ui.mobileFontFamily,
