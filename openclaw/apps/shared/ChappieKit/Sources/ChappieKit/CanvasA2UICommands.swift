...
public enum ChappieCanvasA2UICommand: String, Codable, Sendable {
...
public struct ChappieCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ChappieCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
