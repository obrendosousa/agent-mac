...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.chappie", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.chappie", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ChappieProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
