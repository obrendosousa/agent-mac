...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: ChappieProtocol.AnyCodable]?
    {
        ...
        return [
            "id": ChappieProtocol.AnyCodable(identity.deviceId),
            "publicKey": ChappieProtocol.AnyCodable(publicKey),
            "signature": ChappieProtocol.AnyCodable(signature),
            "signedAt": ChappieProtocol.AnyCodable(signedAtMs),
            "nonce": ChappieProtocol.AnyCodable(nonce),
        ]
    }
}
