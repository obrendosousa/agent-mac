...
public struct ChappieChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct ChappieChatSessionsDefaults: Codable, Sendable {
...
public struct ChappieChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct ChappieChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: ChappieChatSessionsDefaults?
    public let sessions: [ChappieChatSessionEntry]
    ...
    public init(
        ...
        sessions: [ChappieChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
