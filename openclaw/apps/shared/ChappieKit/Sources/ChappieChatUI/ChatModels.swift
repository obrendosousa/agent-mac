...
public typealias ChappiePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ChappiePlatformImage = UIImage
#endif

public struct ChappieChatUsageCost: Codable, Hashable, Sendable {
...
public struct ChappieChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ChappieChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ChappieChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ChappieChatMessageContent: Codable, Hashable, Sendable {
...
public struct ChappieChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ChappieChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ChappieChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ChappieChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ChappieChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ChappieChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ChappieChatMessageContent].self, forKey: .content) {
...
public struct ChappieChatHistoryPayload: Codable, Sendable {
...
public struct ChappieSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ChappieSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ChappieSessionPreviewItem]
}

public struct ChappieSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ChappieSessionPreviewEntry]

    public init(ts: Int, previews: [ChappieSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ChappieChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ChappieChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ChappieAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ChappieChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ChappieGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ChappiePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ChappiePlatformImage?
...
public struct ChappieChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
