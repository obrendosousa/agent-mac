...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = ChappieChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = ChappieChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
