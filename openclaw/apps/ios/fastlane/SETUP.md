...
ASC_KEYCHAIN_SERVICE=chappie-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.chappie.client
# or
...
- The beta flow regenerates `apps/ios/Chappie.xcodeproj` from `apps/ios/project.yml` before archiving
