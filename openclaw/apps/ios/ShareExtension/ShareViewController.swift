...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.chappie.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Chappie", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Chappie gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Chappie.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "ChappieShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Chappie is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Chappie Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("chappie-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
