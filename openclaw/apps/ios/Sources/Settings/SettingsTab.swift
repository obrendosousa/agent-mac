...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ChappieLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ChappieLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.chappie.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Chappie agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Chappie agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Chappie. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ChappieLocationMode.off.rawValue)
                            Text("While Using").tag(ChappieLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ChappieLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Chappie is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Chappie", value: DeviceInfoHelper.chappieVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ChappieLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Chappie chat and run /pair approve, then tap Connect again."
        }
