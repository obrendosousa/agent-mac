...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ChappiePhotosLatestParams) async throws -> ChappiePhotosLatestPayload {
        ...
        var results: [ChappiePhotoPayload] = []
        ...
        return ChappiePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ChappiePhotoPayload
    {
