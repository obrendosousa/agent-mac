...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.chappie.gateway"
    private static let nodeService = "ai.chappie.node"
    private static let talkService = "ai.chappie.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.chappie.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.chappie.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("chappie-gateway.log")
    }
