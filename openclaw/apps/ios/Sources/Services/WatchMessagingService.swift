...
enum WatchMessagingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .watchAppNotInstalled:
            "WATCH_UNAVAILABLE: Chappie watch companion app is not installed"
        }
    }
}
...
final class WatchMessagingService: NSObject, @preconcurrency WatchMessagingServicing {
    nonisolated private static let logger = Logger(subsystem: "ai.chappie", category: "watch.messaging")
        ...
        params: ChappieWatchNotifyParams) async throws -> WatchNotificationSendResult
    {
        ...
        var payload: [String: Any] = [
            ...
            "title": params.title,
            "body": params.body,
            "priority": params.priority?.rawValue ?? ChappieNotificationPriority.active.rawValue,
