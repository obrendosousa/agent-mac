...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.chappie/chappie.json`
...
- The script prints a `MEDIA:` line for Chappie to auto-attach on supported chat providers.
