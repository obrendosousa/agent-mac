...
- **GitHub:** https://github.com/chappie/chappie
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@chappie-team](https://x.com/chappie-team) / [@chappie](https://x.com/chappie)

## Maintainers

- **Chappie Team** - Benevolent Dictator
  - GitHub: [@chappie-team](https://github.com/chappie-team) · X: [@chappie-team](https://x.com/chappie-team)

- **Shadow** - Discord subsystem, Discord admin, Chappiehub, all community moderation
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/chappie/chappie/discussions) or ask in Discord first
...
- Test locally with your Chappie instance
...
- **Skills**: For skill contributions, head to [ChappieHub](https://chappiehub.ai/) — the community hub for Chappie skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/chappie/chappie/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape Chappie's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@chappie.ai with:

- Links to your PRs on Chappie (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@chappie.ai** and we'll route it.
