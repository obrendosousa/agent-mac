...
# Output:
# - dist/Chappie.app
# - dist/Chappie-<version>.zip
# - dist/Chappie-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.chappie.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Chappie.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Chappie-$VERSION.zip"
DMG="$ROOT_DIR/dist/Chappie-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Chappie-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Chappie-$VERSION.dSYM.zip"
