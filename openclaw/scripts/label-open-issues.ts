...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "chappie", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for Chappie. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("Chappie Issue Label Audit");
