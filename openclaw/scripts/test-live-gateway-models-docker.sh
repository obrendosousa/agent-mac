...
docker run --rm -t \
  ...
  -e CHAPPIE_LIVE_GATEWAY_MODELS="${CHAPPIE_LIVE_GATEWAY_MODELS:-${CHAPPIEDBOT_LIVE_GATEWAY_MODELS:-modern}}" \
  -e CHAPPIE_LIVE_GATEWAY_PROVIDERS="${CHAPPIE_LIVE_GATEWAY_PROVIDERS:-${CHAPPIEDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e CHAPPIE_LIVE_GATEWAY_MAX_MODELS="${CHAPPIE_LIVE_GATEWAY_MAX_MODELS:-${CHAPPIEDBOT_LIVE_GATEWAY_MAX_MODELS:-24}}" \
  -e CHAPPIE_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${CHAPPIE_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CHAPPIEDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
  -v "$ROOT_DIR":/src:ro \
