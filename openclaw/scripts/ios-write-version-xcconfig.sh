...
- CHAPPIE_GATEWAY_VERSION = exact package.json version
- CHAPPIE_MARKETING_VERSION = short iOS/App Store version
- CHAPPIE_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
CHAPPIE_GATEWAY_VERSION = ${PACKAGE_VERSION}
CHAPPIE_MARKETING_VERSION = ${MARKETING_VERSION}
CHAPPIE_BUILD_VERSION = ${BUILD_NUMBER}
EOF
