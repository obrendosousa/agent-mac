...
export DISPLAY=:1
export HOME=/tmp/chappie-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${CHAPPIE_BROWSER_CDP_PORT:-${CHAPPIEDBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${CHAPPIE_BROWSER_CDP_SOURCE_RANGE:-${CHAPPIEDBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${CHAPPIE_BROWSER_VNC_PORT:-${CHAPPIEDBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${CHAPPIE_BROWSER_NOVNC_PORT:-${CHAPPIEDBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${CHAPPIE_BROWSER_ENABLE_NOVNC:-${CHAPPIEDBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${CHAPPIE_BROWSER_HEADLESS:-${CHAPPIEDBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${CHAPPIE_BROWSER_NO_SANDBOX:-${CHAPPIEDBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${CHAPPIE_BROWSER_NOVNC_PASSWORD:-${CHAPPIEDBOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${CHAPPIE_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${CHAPPIE_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${CHAPPIE_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
