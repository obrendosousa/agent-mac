...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "chappie-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["CHAPPIE_BUNDLED_HOOKS_DIR"]);
    process.env.CHAPPIE_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: ChappieConfig) => {
