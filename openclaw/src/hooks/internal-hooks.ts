/**
 * Hook system for Chappie agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __chappie_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__chappie_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
