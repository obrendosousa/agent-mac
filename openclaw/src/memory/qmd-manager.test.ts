...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: ChappieConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: ChappieConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__chappieMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__chappieMcporterColdStartWarned;
  });
