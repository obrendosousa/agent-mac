...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ChappieConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ChappieConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: ChappieConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: ChappieConfig }): Promise<void> {
