...
function buildSessionPresentation(params: {
  ...
  const configOptions: SessionConfigOption[] = [
    buildSelectConfigOption({
      ...
      description:
        "Controls how much deliberate reasoning Chappie requests from the Gateway model.",
    ...
    buildSelectConfigOption({
      ...
      name: "Tool verbosity",
      description:
        "Controls how much tool progress and output detail Chappie keeps enabled for the session.",
    ...
    buildSelectConfigOption({
      ...
      name: "Usage detail",
      description:
        "Controls how much usage information Chappie attaches to responses for the session.",
...
export class AcpGatewayAgent implements Agent {
  ...
  private assertSupportedSessionSetup(mcpServers: ReadonlyArray<unknown>): void {
    ...
    throw new Error(
      "ACP bridge mode does not support per-session MCP servers. Configure MCP on the Chappie gateway or agent instead.",
    );
  }
