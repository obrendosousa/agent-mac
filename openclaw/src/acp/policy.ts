...
export function isAcpEnabledByPolicy(cfg: ChappieConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ChappieConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ChappieConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ChappieConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ChappieConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ChappieConfig, agentId: string): boolean {
