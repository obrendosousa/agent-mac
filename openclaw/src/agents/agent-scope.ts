...
type AgentEntry = NonNullable<NonNullable<ChappieConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: ChappieConfig): AgentEntry[] {
...
export function listAgentIds(cfg: ChappieConfig): string[] {
...
export function resolveDefaultAgentId(cfg: ChappieConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: ChappieConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: ChappieConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: ChappieConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: ChappieConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
