...
function buildCoreToolGroupMap() {
  ...
  const chappieTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInChappieGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:chappie": chappieTools,
