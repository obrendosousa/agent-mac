...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/chappie/chappie/issues/31298
    previousFastTestEnv = process.env.CHAPPIE_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.CHAPPIE_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // CHAPPIE_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Chappie runtime context (internal):");
