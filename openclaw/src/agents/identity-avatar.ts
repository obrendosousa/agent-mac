...
function resolveAvatarSource(cfg: ChappieConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ChappieConfig, agentId: string): AgentAvatarResolution {
