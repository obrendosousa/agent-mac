...
export const DEFAULT_SANDBOX_IMAGE = "chappie-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "chappie-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "chappie-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "chappie-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "chappie-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "chappie-sandbox-browser";
