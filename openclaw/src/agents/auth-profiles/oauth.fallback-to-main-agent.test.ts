...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveChappieAgentDir() returns mainAgentDir
    process.env.CHAPPIE_STATE_DIR = tmpDir;
    process.env.CHAPPIE_AGENT_DIR = mainAgentDir;
