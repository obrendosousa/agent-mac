...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): ChappieConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: ChappieConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: ChappieConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
