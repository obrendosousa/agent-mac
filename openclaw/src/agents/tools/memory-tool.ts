...
function resolveMemoryToolContext(options: { config?: ChappieConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: ChappieConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: ChappieConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: ChappieConfig): MemoryCitationsMode {
