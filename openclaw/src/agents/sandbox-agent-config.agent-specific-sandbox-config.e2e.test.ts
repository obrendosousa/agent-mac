...
async function resolveContext(config: ChappieConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): ChappieConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
