...
const CLEANUP_STATE_KEY = Symbol.for("chappie.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("chappie.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("chappie.sessionWriteLockWatchdogState");
