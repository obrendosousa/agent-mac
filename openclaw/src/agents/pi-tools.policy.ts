...
export function resolveSubagentToolPolicy(cfg?: ChappieConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: ChappieConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: ChappieConfig["tools"];
