...
function resolvePostCompactionIndexSyncMode(config?: ChappieConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureChappieModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createChappieCodingTools({
      exec: {
