...
function resolveWatchPaths(workspaceDir: string, config?: ChappieConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ChappieConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ChappieConfig }) {
