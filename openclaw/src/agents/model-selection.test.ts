...
function resolveAnthropicOpusThinking(cfg: ChappieConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<ChappieConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<ChappieConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<ChappieConfig> = {
        agents: {
          defaults: {
            models: {
