...
const defaultTools = createChappieCodingTools({ senderIsOwner: true });
...
describe("createChappieCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: ChappieConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createChappieCodingTools({
    ...
    const anthropicTools = createChappieCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: ChappieConfig = {
      tools: {
        exec: {
    ...
    const allowed = createChappieCodingTools({
    ...
    const denied = createChappieCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createChappieCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
