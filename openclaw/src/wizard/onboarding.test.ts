...
vi.mock("../commands/onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "/tmp/chappie-workspace",
...
describe("runOnboardingWizard", () => {
  ...
  beforeAll(async () => {
    suiteRoot = await fs.mkdtemp(path.join(os.tmpdir(), "chappie-onboard-suite-"));
  });
  ...
  it("resolves gateway.auth.password SecretRef for local onboarding probe", async () => {
    ...
    process.env.CHAPPIE_GATEWAY_PASSWORD = "gateway-ref-password"; // pragma: allowlist secret
