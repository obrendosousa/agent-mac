...
export const PLUGIN_MANIFEST_FILENAME = "chappie.plugin.json";
...
// package.json "chappie" metadata (used for onboarding/catalog)
...
export type ChappiePackageManifest = {
  extensions?: string[];
...
): ChappiePackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
