...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ChappieConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ChappieConfig): void {
