import type { GatewayAuthConfig, ChappieConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: ChappieConfig, password: string): ChappieConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
