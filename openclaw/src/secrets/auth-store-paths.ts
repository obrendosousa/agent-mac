...
export function listAuthProfileStorePaths(config: ChappieConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: ChappieConfig, stateDir: string): string[] {
