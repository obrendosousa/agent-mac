...
function resolveResolutionLimits(config: ChappieConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: ChappieConfig): SecretProviderConfig {
