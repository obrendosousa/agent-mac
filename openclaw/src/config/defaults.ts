...
function resolveAnthropicDefaultAuthMode(cfg: ChappieConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ChappieConfig): ChappieConfig {
...
export function applyTalkApiKey(config: ChappieConfig): ChappieConfig {
...
export function applyTalkConfigNormalization(config: ChappieConfig): ChappieConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ChappieConfig): ChappieConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ChappieConfig): ChappieConfig {
...
export function applyLoggingDefaults(cfg: ChappieConfig): ChappieConfig {
...
export function applyContextPruningDefaults(cfg: ChappieConfig): ChappieConfig {
...
export function applyCompactionDefaults(cfg: ChappieConfig): ChappieConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
