...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.CHAPPIE_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.CHAPPIE_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.CHAPPIE_SERVICE_MARKER = originalServiceMarker;
    }
  });
