...
let originalChappieTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalChappieTestConsole = process.env.CHAPPIE_TEST_CONSOLE;
  process.env.CHAPPIE_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalChappieTestConsole === undefined) {
    delete process.env.CHAPPIE_TEST_CONSOLE;
  } else {
    process.env.CHAPPIE_TEST_CONSOLE = originalChappieTestConsole;
  }
