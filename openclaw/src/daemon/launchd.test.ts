...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.chappie.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.chappie.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", CHAPPIE_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.chappie.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when CHAPPIE_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.chappie.gateway.plist",
    },
    {
      name: "uses profile-specific label when CHAPPIE_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", CHAPPIE_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.chappie.jbphoenix.plist",
    },
    {
      name: "prefers CHAPPIE_LAUNCHD_LABEL over CHAPPIE_PROFILE",
      env: {
        HOME: "/Users/test",
        CHAPPIE_PROFILE: "jbphoenix",
        CHAPPIE_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from CHAPPIE_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        CHAPPIE_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty CHAPPIE_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        CHAPPIE_PROFILE: "myprofile",
        CHAPPIE_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.chappie.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
