...
export const A2UI_PATH = "/__chappie__/a2ui";

export const CANVAS_HOST_PATH = "/__chappie__/canvas";

export const CANVAS_WS_PATH = "/__chappie__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.chappieCanvasA2UIAction.postMessage(...)
  // - Android: window.chappieCanvasA2UIAction.postMessage(...)
  const handlerNames = ["chappieCanvasA2UIAction"];
  ...
  globalThis.Chappie = globalThis.Chappie ?? {};
  globalThis.Chappie.postMessage = postToNode;
  globalThis.Chappie.sendUserAction = sendUserAction;
  globalThis.chappiePostMessage = postToNode;
  globalThis.chappieSendUserAction = sendUserAction;
