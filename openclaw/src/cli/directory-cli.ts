    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["chappie directory self --channel slack", "Show the connected account identity."],
          [
            'chappie directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["chappie directory groups list --channel discord", "List available groups/channels."],
          [
            "chappie directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.chappie.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
