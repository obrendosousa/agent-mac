      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["chappie gateway run", "Run the gateway in the foreground."],
            ["chappie gateway status", "Show service status and probe reachability."],
            ["chappie gateway discover", "Find local and wide-area gateway beacons."],
            ["chappie gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.chappie.ai/cli/gateway")}\n`,
      ),
  );
