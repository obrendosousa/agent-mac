    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["chappie channels list", "List configured channels and auth profiles."],
          ["chappie channels status --probe", "Run channel status checks and probes."],
          [
            "chappie channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["chappie channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.chappie.ai/cli/channels",
        )}\n`,
    );
