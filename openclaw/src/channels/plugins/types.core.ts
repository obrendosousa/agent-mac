...
export type ChannelAgentToolFactory = (params: { cfg?: ChappieConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ChappieConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: ChappieConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ChappieConfig }) => boolean;
  supportsCards?: (params: { cfg: ChappieConfig }) => boolean;
