...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: ChappieConfig): string | undefined {
  ...
  function listAccountIds(cfg: ChappieConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: ChappieConfig): string {
