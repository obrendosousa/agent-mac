...
export function listChannelMessageActions(cfg: ChappieConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ChappieConfig): boolean {
...
export function supportsChannelMessageCards(cfg: ChappieConfig): boolean {
