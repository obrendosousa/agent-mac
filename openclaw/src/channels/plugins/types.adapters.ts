...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: ChappieConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: ChappieConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: ChappieConfig) => string;
  setAccountEnabled?: (params: {
    cfg: ChappieConfig;
    accountId: string;
    enabled: boolean;
  }) => ChappieConfig;
  deleteAccount?: (params: { cfg: ChappieConfig; accountId: string }) => ChappieConfig;
  isEnabled?: (account: ResolvedAccount, cfg: ChappieConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: ChappieConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: ChappieConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: ChappieConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: ChappieConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.chappie.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: ChappieConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
