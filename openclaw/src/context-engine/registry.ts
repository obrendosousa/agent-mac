...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("chappie.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: ChappieConfig): Promise<ContextEngine> {
