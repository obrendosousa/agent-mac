...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ChappieConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ChappieConfig; env: NodeJS.ProcessEnv }): {
  cfg: ChappieConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
