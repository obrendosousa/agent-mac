...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when CHAPPIE_VERSION is not set", async () => {
  ...
  it("prefers CHAPPIE_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over CHAPPIE_SERVICE_VERSION when CHAPPIE_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        CHAPPIE_VERSION: " ",
        CHAPPIE_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when CHAPPIE_VERSION and CHAPPIE_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        CHAPPIE_VERSION: " ",
        CHAPPIE_SERVICE_VERSION: "\t",
