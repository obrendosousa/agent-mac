...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.chappie.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("chappie hooks list")}`,
      `  ${formatCliCommand("chappie hooks enable <name>")}`,
      `  ${formatCliCommand("chappie hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
