...
export function applyProviderDefaultModel(cfg: ChappieConfig, modelRef: string): ChappieConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: ChappieConfig; modelId: string; modelRef: string; profileId: string } {
