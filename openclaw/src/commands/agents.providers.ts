...
function resolveDefaultAccountId(cfg: ChappieConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ChappieConfig): boolean {
...
export function summarizeBindings(cfg: ChappieConfig, bindings: AgentBinding[]): string[] {
