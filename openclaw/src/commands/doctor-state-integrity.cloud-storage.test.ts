...
describe("detectMacCloudSyncedStateDir", () => {
  ...
  it("detects state dir under Library/CloudStorage", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "Dropbox", "Chappie", ".chappie");
  ...
  it("detects cloud-synced target when state dir resolves via symlink", () => {
    const symlinkPath = "/tmp/chappie-state";
  ...
  it("ignores cloud-synced symlink prefix when resolved target is local", () => {
    ...
    const resolvedLocalPath = path.join(home, ".chappie");
  ...
  it("anchors cloud detection to OS homedir when CHAPPIE_HOME is overridden", () => {
    const stateDir = path.join(home, "Library", "CloudStorage", "iCloud Drive", ".chappie");
    const originalChappieHome = process.env.CHAPPIE_HOME;
    process.env.CHAPPIE_HOME = "/tmp/chappie-home-override";
