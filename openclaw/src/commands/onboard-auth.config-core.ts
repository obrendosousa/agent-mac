...
export function applyOpenrouterProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: ChappieConfig): ChappieConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: ChappieConfig): ChappieConfig {
...
export function applyMoonshotConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: ChappieConfig): ChappieConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ChappieConfig): ChappieConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ChappieConfig): ChappieConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: ChappieConfig): ChappieConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: ChappieConfig): ChappieConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: ChappieConfig): ChappieConfig {
...
export function applyQianfanProviderConfig(cfg: ChappieConfig): ChappieConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: ChappieConfig): ChappieConfig {
...
export function applyModelStudioProviderConfig(cfg: ChappieConfig): ChappieConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: ChappieConfig): ChappieConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: ChappieConfig): ChappieConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: ChappieConfig): ChappieConfig {
