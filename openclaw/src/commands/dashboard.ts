...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set CHAPPIE_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `chappie dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Chappie.");
  } else if (hint) {
    runtime.log(hint);
  }
}
