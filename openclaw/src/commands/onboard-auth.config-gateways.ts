...
export function applyVercelAiGatewayProviderConfig(cfg: ChappieConfig): ChappieConfig {
...
export function applyVercelAiGatewayConfig(cfg: ChappieConfig): ChappieConfig {
