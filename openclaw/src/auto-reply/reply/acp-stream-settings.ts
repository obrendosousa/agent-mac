...
function resolveAcpStreamCoalesceIdleMs(cfg: ChappieConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: ChappieConfig): number {
...
export function resolveAcpProjectionSettings(cfg: ChappieConfig): AcpProjectionSettings {
