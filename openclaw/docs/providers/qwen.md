---
summary: "Use Qwen OAuth (free tier) in Chappie"
read_when:
  - You want to use Qwen with Chappie
...
If you already logged in with the Qwen Code CLI, Chappie will sync credentials
