...
You can point Chappie at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Chappie
...
- [Anthropic provider](/providers/anthropic) - Native Chappie integration with Claude setup-token or API keys
