---
summary: "Use Qianfan's unified API to access many models in Chappie"
read_when:
...
3. Chappie installed on your system
...
4. Copy the API key for use with Chappie

## CLI setup

```bash
chappie onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Chappie Configuration](/gateway/configuration)
