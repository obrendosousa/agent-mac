---
summary: "Use NVIDIA's OpenAI-compatible API in Chappie"
read_when:
  - You want to use NVIDIA models in Chappie
...
chappie onboard --auth-choice skip
chappie models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
