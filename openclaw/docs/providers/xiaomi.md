---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Chappie"
read_when:
  - You want Xiaomi MiMo models in Chappie
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Chappie uses
