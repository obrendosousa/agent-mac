---
summary: "Use Synthetic's Anthropic-compatible API in Chappie"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Chappie registers it as the
...
Note: Chappie's Anthropic client appends `/v1` to the base URL, so use
