...
# WhatsApp
chappie message poll --target +15555550123 \
  --poll-question "Lunch today?" --poll-option "Yes" --poll-option "No" --poll-option "Maybe"
chappie message poll --target 123456789@g.us \
  --poll-question "Meeting time?" --poll-option "10am" --poll-option "2pm" --poll-option "4pm" --poll-multi

# Discord
chappie message poll --channel discord --target channel:123456789 \
  --poll-question "Snack?" --poll-option "Pizza" --poll-option "Sushi"
chappie message poll --channel discord --target channel:123456789 \
  --poll-question "Plan?" --poll-option "A" --poll-option "B" --poll-duration-hours 48

# MS Teams
chappie message poll --channel msteams --target conversation:19:abc@thread.tacv2 \
...
- MS Teams: Adaptive Card polls (Chappie-managed). No native poll API; `durationHours` is ignored.
...
to record votes in `~/.chappie/msteams-polls.json`.
