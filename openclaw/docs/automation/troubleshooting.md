...
chappie system heartbeat last
chappie logs --follow
chappie config get agents.defaults.heartbeat
chappie channels status --probe
```
...
```bash
chappie config get agents.defaults.heartbeat.activeHours
chappie config get agents.defaults.heartbeat.activeHours.timezone
chappie config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
chappie cron list
chappie logs --follow
```
