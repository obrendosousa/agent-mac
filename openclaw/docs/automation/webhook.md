...
read_when:
  ...
  - Wiring external systems into Chappie
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Chappie config directory (typically `~/.chappie/hooks/transforms`).
...
- `chappie webhooks gmail setup` writes `hooks.gmail` config for `chappie webhooks gmail run`.
