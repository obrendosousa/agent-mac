...
Chappie treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.chappie/settings/voicewake.json`

Shape:

```json
{ "triggers": ["chappie", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
