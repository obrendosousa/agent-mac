...
Chappie ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Chappie also aligns
the install method:
...
When you switch channels with `chappie update`, Chappie also syncs plugin sources:
