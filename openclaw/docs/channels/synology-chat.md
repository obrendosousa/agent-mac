---
summary: "Synology Chat webhook setup and Chappie config"
read_when:
  - Setting up Synology Chat with Chappie
...
```bash
chappie plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Chappie gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Chappie.
...
- Pairing approvals work with:
  - `chappie pairing list synology-chat`
  - `chappie pairing approve synology-chat <CODE>`
...
```bash
chappie message send --channel synology-chat --target 123456 --text "Hello from Chappie"
chappie message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
