...
- Install via CLI: `chappie plugins install @chappie/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `chappie plugins install ./extensions/zalo`
   - From npm (if published): `chappie plugins install @chappie/zalo`
...
- Approve via:
  - `chappie pairing list zalo`
  - `chappie pairing approve zalo <CODE>`
...
- Example: `chappie message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `chappie channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `chappie logs --follow`
