...
Chappie treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

Chappie “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Chappie can see that group and respond there.
...
Translation: allowlisted senders can trigger Chappie by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@chappie", "chappie", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
