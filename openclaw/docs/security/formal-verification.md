...
summary: Machine-checked security models for Chappie’s highest-risk paths.
read_when:
...
This page tracks Chappie’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Chappie enforces its
...
**What this is not (yet):** a proof that “Chappie is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/chappie-formal-models](https://github.com/vignesh07/chappie-formal-models).
...
```bash
git clone https://github.com/vignesh07/chappie-formal-models
cd chappie-formal-models
