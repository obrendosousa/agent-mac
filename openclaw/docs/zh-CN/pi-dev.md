...
本指南总结了在 Chappie 中开发 Pi 集成的合理工作流程。
...
状态存储在 Chappie 状态目录下。默认为 `~/.chappie`。如果设置了 `CHAPPIE_STATE_DIR`，则使用该目录。
...
- https://docs.chappie.ai/testing
- https://docs.chappie.ai/start/getting-started
