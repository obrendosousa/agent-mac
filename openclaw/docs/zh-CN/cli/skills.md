...
summary: "`chappie skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- ChappieHub 安装：[ChappieHub](/tools/chappiehub)

## 命令

```bash
chappie skills list
chappie skills list --eligible
chappie skills info <name>
chappie skills check
```
