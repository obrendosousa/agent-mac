...
read_when:
  - You want to publish a third-party Chappie plugin
...
This page tracks high-quality **community-maintained plugins** for Chappie.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `chappie plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `chappie plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Chappie to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/chappie-wechat`
  repo: `https://github.com/icesword0760/chappie-wechat`
  install: `chappie plugins install @icesword760/chappie-wechat`
