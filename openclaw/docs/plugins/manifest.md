...
read_when:
  - You are building a Chappie plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (chappie.plugin.json)

Every plugin **must** ship a `chappie.plugin.json` file in the **plugin root**.
Chappie uses this manifest to validate configuration **without executing plugin
