---
summary: "Overview of Chappie onboarding options and flows"
read_when:
...
Chappie supports multiple onboarding paths depending on where the Gateway runs
...
- [`chappie onboard` command](/cli/onboard)

## macOS app onboarding

Use the Chappie app when you want a fully guided setup on macOS. Docs:
