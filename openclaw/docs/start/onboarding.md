---
summary: "First-run onboarding flow for Chappie (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Chappie">
...
<Step title="CLI">
  ...
  The app can install the global `chappie` CLI via npm/pnpm so terminal
