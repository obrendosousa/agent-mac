---
summary: "Backstory and lore of Chappie for context and tone"
read_when:
...
For a while, the lobster was called **Clawd**, living in a **Chappiedbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Chappie**.
...
In the end, **Chappie** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.chappie/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Chappie. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Chappie): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "chappie what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with chappie."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @chappie. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.

**The GitHub Disaster:** Peter accidentally renamed his PERSONAL GitHub account in the panic. Bots sniped `chappie-team` within minutes. GitHub's SVP was contacted.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Chappie" to promote pump-and-dump tokens.
...
**The Great Chappie Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/chappie/chappie` ✅
- X handle `@chappie` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.chappie.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $CHAPPIE token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
