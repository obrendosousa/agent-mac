...
import { createAccountListHelpers, type ChappieConfig } from "chappie/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: ChappieConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ChappieConfig): ResolvedZaloAccount[] {
