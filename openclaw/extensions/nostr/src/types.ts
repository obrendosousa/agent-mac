...
} from "chappie/plugin-sdk/account-id";
import type { ChappieConfig } from "chappie/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: ChappieConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: ChappieConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: ChappieConfig): string {
