import { AllowFromListSchema, DmPolicySchema } from "chappie/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "chappie/plugin-sdk/nostr";
import { z } from "zod";
