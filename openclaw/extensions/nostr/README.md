...
Nostr DM channel plugin for Chappie using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Chappie. It enables your bot to:
...
# Configure chappie to use local relay
