...
export function listWhatsAppAuthDirs(cfg: ChappieConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ChappieConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ChappieConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ChappieConfig): ResolvedWhatsAppAccount[] {
