...
import { createAccountListHelpers, type ChappieConfig } from "chappie/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: ChappieConfig): ResolvedMattermostAccount[] {
