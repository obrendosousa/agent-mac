import {
  ...
  type ChappieConfig,
} from "chappie/plugin-sdk/mattermost";
export { createDedupeCache, rawDataToString } from "chappie/plugin-sdk/mattermost";
...
function listAgents(cfg: ChappieConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: ChappieConfig, agentId: string): string | undefined {
