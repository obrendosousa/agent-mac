...
import type { ChappiePluginApi } from "chappie/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("chappie/plugin-sdk/mattermost").ChappieConfig;
    runtime: import("chappie/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: ChappiePluginApi) {
