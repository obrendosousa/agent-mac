...
import { fetchWithSsrFGuard, isWSL2Sync } from "chappie/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["CHAPPIE_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Chappie.</p></body></html>",
        );
