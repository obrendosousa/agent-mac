...
import { isSecretRef } from "chappie/plugin-sdk/googlechat";
import { createAccountListHelpers, type ChappieConfig } from "chappie/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: ChappieConfig): ResolvedGoogleChatAccount[] {
