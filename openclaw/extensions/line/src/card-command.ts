import type { LineChannelData, ChappiePluginApi, ReplyPayload } from "chappie/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ChappiePluginApi): void {
  api.registerCommand({
    name: "card",
