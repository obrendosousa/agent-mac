import type { ChappieConfig, PluginRuntime, ResolvedLineAccount } from "chappie/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: ChappieConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: ChappieConfig; accountId: string }): Promise<{
