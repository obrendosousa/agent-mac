...
import { createAccountListHelpers, type ChappieConfig } from "chappie/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: ChappieConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: ChappieConfig; accountId?: string | null }) {
