import type { ChappieConfig, ChappiePluginApi } from "chappie/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: ChappieConfig): { id: string; name: string } {
