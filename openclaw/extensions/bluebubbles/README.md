...
This directory contains the **BlueBubbles external channel plugin** for Chappie.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `chappie/plugin-sdk` helpers.
