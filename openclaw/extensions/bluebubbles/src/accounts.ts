...
import { createAccountListHelpers, type ChappieConfig } from "chappie/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: ChappieConfig): ResolvedBlueBubblesAccount[] {
