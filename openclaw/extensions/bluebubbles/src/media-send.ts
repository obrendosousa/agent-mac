...
import { resolveChannelMediaMaxBytes, type ChappieConfig } from "chappie/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: ChappieConfig; accountId?: string }): string[] {
