/**
 * Twitch channel plugin for Chappie.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { ChappieConfig } from "chappie/plugin-sdk/twitch";
import { buildChannelConfigSchema } from "chappie/plugin-sdk/twitch";
 ...
 * for Chappie. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: ChappieConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: ChappieConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: ChappieConfig): boolean => {
