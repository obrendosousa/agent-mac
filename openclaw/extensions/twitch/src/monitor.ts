...
import type { ReplyPayload, ChappieConfig } from "chappie/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "chappie/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ChappieConfig;
