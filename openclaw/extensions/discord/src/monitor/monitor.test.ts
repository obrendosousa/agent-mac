...
describe("agent components", () => {
  const createCfg = (): ChappieConfig => ({}) as ChappieConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/chappie-sessions-test.json");
  });
