...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "chappie/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: ChappiePluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: ChappiePluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
