...
export const tlonPlugin: ChannelPlugin = {
  ...
  status: {
    ...
    buildAccountSnapshot: ({ account, runtime, probe }) => {
      ...
      return snapshot as import("chappie/plugin-sdk/tlon").ChannelAccountSnapshot;
    },
  },
  gateway: {
    startAccount: async (ctx) => {
      ...
      ctx.setStatus({
        ...
        ship: account.ship,
        url: account.url,
      } as import("chappie/plugin-sdk/tlon").ChannelAccountSnapshot);
