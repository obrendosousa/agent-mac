...
import { fetchWithSsrFGuard } from "chappie/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Chappie workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".chappie", "workspace", "media", "inbound");
 ...
 * Format matches Chappie's expected attachment structure.
 */
