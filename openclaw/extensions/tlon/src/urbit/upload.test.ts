...
vi.mock("chappie/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("chappie/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  async function loadUploadMocks() {
    const { fetchWithSsrFGuard } = await import("chappie/plugin-sdk/tlon");
