...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "chappie/plugin-sdk/msteams";
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredChappieTmpDir(), "msteams-mention-"));
