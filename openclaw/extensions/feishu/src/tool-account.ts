...
import type { ChappiePluginApi } from "chappie/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: ChappiePluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<ChappiePluginApi, "config">;
