import type { PluginRuntime } from "chappie/plugin-sdk/test-utils";
import { removeAckReactionAfterReply, shouldAckReaction } from "chappie/plugin-sdk/test-utils";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/chappie"),
    },
    modelAuth: {
