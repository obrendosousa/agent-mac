...
function mergeIMessageAccountConfig(cfg: ChappieConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ChappieConfig): ResolvedIMessageAccount[] {
