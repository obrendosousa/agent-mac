...
const UPDATE_BANNER_DISMISS_KEY = "chappie:control-ui:update-banner-dismissed:v1";
              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="Chappie" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${t("nav.control")}</span>
                          <span class="sidebar-brand__title">Chappie</span>
                        </span>
                      `
                }
              </div>
