...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as ChappieApp);
      void loadAgents(host as unknown as ChappieApp);
      void loadHealthState(host as unknown as ChappieApp);
      void loadNodes(host as unknown as ChappieApp, { quiet: true });
      void loadDevices(host as unknown as ChappieApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as ChappieApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as ChappieApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as ChappieApp, payload);
