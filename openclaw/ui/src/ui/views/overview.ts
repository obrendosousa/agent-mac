...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">chappie devices list</span><br />
          <span class="mono">chappie devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.chappie.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">chappie dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">chappie doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "chappie dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.chappie.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.chappie.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.chappie.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px;">
                    <input
                      ...
                      placeholder="CHAPPIE_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
            ...
            ? html`
                <div class="login-gate__help" style="margin-top: 16px;">
                  ...
                  <ol class="login-gate__steps">
                    <li>${t("overview.connection.step1")}<code>chappie gateway run</code></li>
                    <li>${t("overview.connection.step2")}<code>chappie dashboard --no-open</code></li>
                    <li>${t("overview.connection.step3")}</li>
                    <li>${t("overview.connection.step4")}<code>chappie doctor --generate-gateway-token</code></li>
                  </ol>
