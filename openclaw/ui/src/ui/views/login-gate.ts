    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Chappie" />
          <div class="login-gate__title">Chappie</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="CHAPPIE_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
